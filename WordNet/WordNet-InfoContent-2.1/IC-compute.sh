...
## Semcor as raw text) version doesn't matter since tags ignored

semCorRawFreq.pl --compfile $comp --outfile ic-semcorraw.dat \
 --stopfile $stop --infile $CORPORA/semcor2.1/brown1/tagfiles

semCorRawFreq.pl --compfile $comp --outfile ic-semcorraw-add1.dat \
 --stopfile $stop  --smooth ADD1 --infile $CORPORA/semcor2.1/brown1/tagfiles

semCorRawFreq.pl --compfile $comp --outfile ic-semcorraw-resnik-add1.dat \
 --stopfile $stop  --smooth ADD1 --resnik --infile $CORPORA/semcor2.1/brown1/tagfiles

semCorRawFreq.pl --compfile $comp --outfile ic-semcorraw-resnik.dat \
...
rawtextFreq.pl --compfile $comp --outfile ic-shaks.dat \
 --stopfile $stop  --infile $CORPORA/shaks12.txt

rawtextFreq.pl --compfile $comp --outfile ic-shaks-add1.dat \
 --stopfile $stop  --smooth ADD1  --infile $CORPORA/shaks12.txt

rawtextFreq.pl --compfile $comp --outfile ic-shaks-resnink-add1.dat \
 --stopfile $stop  --smooth ADD1 --resnik  --infile $CORPORA/shaks12.txt

rawtextFreq.pl --compfile $comp --outfile ic-shaks-resnik.dat \
 --stopfile $stop --resnik  --infile $CORPORA/shaks12.txt

## Create information content from treebank

treebankFreq.pl --compfile $comp --outfile ic-treebank.dat \
 --stopfile $stop $CORPORA/TreeBank-2/raw/wsj

treebankFreq.pl --compfile $comp --outfile ic-treebank-add1.dat \
 --stopfile $stop --smooth ADD1 $CORPORA/TreeBank-2/raw/wsj

treebankFreq.pl --compfile $comp --outfile ic-treebank-resnik-add1.dat \
 --stopfile $stop --smooth ADD1 --resnik $CORPORA/TreeBank-2/raw/wsj

treebankFreq.pl --compfile $comp --outfile ic-treebank-resnik.dat \
 --stopfile $stop  --resnik $CORPORA/TreeBank-2/raw/wsj

## Create information content from British National Corpus

BNCFreq.pl --compfile $comp --outfile ic-bnc.dat \
 --stopfile $stop $CORPORA/BNC-World/Texts

BNCFreq.pl --compfile $comp --outfile ic-bnc-add1.dat \
 --stopfile $stop --smooth ADD1 $CORPORA/BNC-World/Texts

BNCFreq.pl --compfile $comp --outfile ic-bnc-resnik-add1.dat \
 --stopfile $stop --smooth ADD1 --resnik $CORPORA/BNC-World/Texts

BNCFreq.pl --compfile $comp --outfile ic-bnc-resnik.dat \
