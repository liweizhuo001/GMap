...
# -*- tcl -*-
# Copyright (C) 2001 ActiveState Corporation Jul 27, 2004
#
# Extension code to tcl8.4/library/init.tcl declaring the
# version information for ActiveTcl.
#
# ActiveState ActiveTcl 8.4.7.0 Win32/x86, Tue Jul 27 11:19:05 PM Pacific Daylight Time 2004
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {win32-ix86}
	buildtime,sec {1090995545}
	buildtime,fmt {Tue Jul 27 11:19:05 PM Pacific Daylight Time 2004}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.4.7.0 Win32/x86, Build 108887 @ Tue Jul 27 11:19:05 PM Pacific Daylight Time 2004 / normal}
    }
}

package provide {ActiveTcl} {8.4.7.0}
