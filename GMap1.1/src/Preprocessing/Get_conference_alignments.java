...
public class Get_conference_alignments {
	...
	{		
		...
		for (int x=0;x<Ontology1.length;x++)
		{
			...
			{			
				String Ontology_name2 = Ontology1[y];
/*		String Ontology_name1="cmt";
		String Ontology_name2="Conference";*/
		String Store_Class_Path="Results/First_line_matcher/"+Ontology_name1+"-"+Ontology_name2+"_class.txt";
		String Store_Property_Path="Results/First_line_matcher/"+Ontology_name1+"-"+Ontology_name2+"_property.txt";
		try{		
		...
		String reference_Path="Datasets/conference_reference_alignments/"+Ontology_name1+"-"+Ontology_name2+".rdf";;//读取本体的路径
