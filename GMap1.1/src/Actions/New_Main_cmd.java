...
/*			System.out.println("基于十字交叉精炼后的匹配对的个数为:"+refinedMap1.size());
		...
		bfw_Result.append("The concept pairs are："+"\n");
		for(int i=0;i<classesMap.size();i++)
		{
			String parts[]=classesMap.get(i).split(",");
		...
		bfw_Result.append("The number of  concept pairs is：："+classesMap.size()+"\n");
		
		System.out.println("*************************************");
		bfw_Result.append("*************************************"+"\n");
		System.out.println("The property pairs are：");
		bfw_Result.append("The property pairs are："+"\n");
		for(int i=0;i<propertiesMap.size();i++)
		{
			String parts[]=propertiesMap.get(i).split(",");
